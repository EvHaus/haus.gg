...
const EXPERIENCE: Array<RoleItemType> = [{
	about: 'Zenhub is a productivity platform SaaS business with around 50 employees. As a member of the leadership team, I am responsible for everything relating to engineering. The product is shipped to Cloud & On-Premise customers.',
	...
	about: 'Cumul8 (subsidiary of Eight Solutions) was a public media technology company that initially focused on software products for the visual effects industry. Over my 7 years there, the company has pivoted to focus on big data and industrial IoT for Enterprise.',
			...
			<Page size='LETTER' style={styles.page}>
				...
				<View style={styles.sidebar}>
					...
					<View style={styles.sidebarSection}>
						...
						<Text style={styles.title}>CTO <Pipe /> Technical Director</Text>
						...
						<Link src='https://haus.gg' style={styles.link}>
							<Text style={styles.website}>www.<Text style={styles.websiteBold}>haus.gg</Text></Text>
						</Link>
						<Link src='https://github.com/EvHaus' style={styles.link}>
							<Text style={styles.website}>www.github.com/<Text style={styles.websiteBold}>EvHaus</Text></Text>
						</Link>
						<Link src='https://linkedIn.com/in/EvHaus' style={styles.link}>
							<Text style={styles.website}>www.linkedIn.com/in/<Text style={styles.websiteBold}>EvHaus</Text></Text>
						</Link>
					</View>
					<View style={styles.sidebarSections}>
						<SectionTitle theme='dark'>
							Tech I Know Really Well
						</SectionTitle>
						<View style={[styles.sidebarSection, styles.sidebarText]}>
							<Text>JavaScript <Pipe /> TypeScript <Pipe /> Node.js</Text>
							<Text>React <Pipe /> Redux <Pipe /> Next.js</Text>
							<Text>HTML <Pipe /> CSS</Text>
						</View>
						<SectionTitle theme='dark'>
							Tech I&apos;ve Used Professionally
						</SectionTitle>
						<View style={[styles.sidebarSection, styles.sidebarText]}>
							<Text>GraphQL <Pipe /> Apollo <Pipe /> React Native</Text>
							<Text>Python <Pipe /> Go <Pipe /> Ruby on Rails <Pipe /> PHP</Text>
							<Text>Kubernetes <Pipe /> Terraform <Pipe /> AWS <Pipe /> GCP</Text>
							<Text>PostgreSQL <Pipe /> MongoDB <Pipe /> MySQL</Text>
							<Text>Photoshop <Pipe /> Figma <Pipe /> Sketch <Pipe /> Abstract</Text>
						</View>
						<SectionTitle theme='dark'>
							Open Source Contributions
						</SectionTitle>
						<View style={[styles.sidebarSection, styles.sidebarText]}>
							<Text>React <Pipe /> ESlint <Pipe /> Meteor <Pipe /> jQuery <Pipe /> Dojo</Text>
							<Text>Backbone <Pipe /> Brackets <Pipe /> Firefox</Text>
						</View>
						<SectionTitle theme='dark'>
							A Bit About Me
						</SectionTitle>
						<View style={[styles.sidebarSection, styles.sidebarText]}>
							<Text>I&apos;m a self-taught coder, a professionally trained designer, animator and musician. I&apos;ve been working with web applications since the early 2000s in a variety of roles. I am obsessed with high quality, attention to detail and efficiency. I strive for balance and rationale in my decisions, and I&apos;m constantly learning. Most of my experience is at small start-ups helping them realize their full potential.</Text>
						</View>
						<View style={[styles.sidebarSection, styles.sidebarText, styles.sidebarFooterText]}>
							<Text>For references, additional information or a complete portfolio of works please contact me at ev@haus.gg</Text>
						</View>
					</View>
				</View>
			</Page>
...
const resume = async (
	...
	// rather than gets downloaded.
	const filetype = process.env.NODE_ENV === 'development' ? 'inline' : 'attachment';

	return res
		.status(200)
		.setHeader('Content-Disposition', `${filetype};filename="resume-ev-haus.pdf"`)
